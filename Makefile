...
IMAGE_NAME = watersupply-competition
OFFICIAL_IMAGE = watersupply.azurecr.io/${IMAGE_NAME}
...
# 2. Local image, e.g., watersupply-competition:gpu-local
# 3. Official competition image, e.g., watersupply.azurecr.io/watersupply-competition
...
## Runs container using code from `submission/submission.zip` and data from WSFR_DATA_ROOT (default `data/`)
